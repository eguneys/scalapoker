  ...
  "an all in should create a sidepot" should {
    ...
    "update last full raise all in" in {
      dealer.seq(
        _.blinds(10),
        _.allin(3)
      ) must bePot("100b 95s 90B 0 100 100!90(. 5 10 100 . .)~!2")
    ...
    "dont update last full raise when all in less than full raise" in {
      dealer2.seq(
        ...
        _.raise(4, 35),
        _.allin(5)
      ) must bePot("100b 85s 70B 70 15 0!35(. 5 10 . 45 50)~!3")
    }
    ...
    "all in not enough money" in {
      dealer3.seq(
        _.blinds(200),
        _.raise(0, 300)
      ) must bePot("500b 900s 550B!300(500 100 200)~!2")

      dealer3.seq(
        _.blinds(200),
        _.raise(0, 300),
        _.call(1)
      ) must bePot("500b 500s 550B!300(500 500 200)~!2")
